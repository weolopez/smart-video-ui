		...
		[
				...
				function($scope, $http, $rootScope) {
					...
					function runVideo() {
						...
						var items = [ [ 0, 0.5, "pop0.png" ], [ 0.5, 1, "pop0.png", "zoomin" ],
								[ 1, 1.5, "pop1.png", "flipin" ],
								[ 1.5, 2, "pop1.png", "zoomin", animate1 ],
								[ 2, 5.5, "pop3.png", "rubber", animate2 ],
								...
								[ 60, 61, "po", "na", animate22 ], [ 61, 86, "po", "na",animate23 ],
									...
									.code({
										...
										onEnd : function(options) {
											if (options.opt != undefined) {
												...
												case "zoomin":
													$('#webpagediv' + options.ind + ' .effect')
															.removeClass("animated zoomIn").width();
													break;
												case "flipin":
													$('#webpagediv' + options.ind + ' .effect')
															.removeClass("animated flipInY").width();
													break;
												case "rubber":
													$('#webpagediv' + options.ind + ' .effect')
															.removeClass("animated rubberBand").width();
													break;
												}
												if (options.classname != undefined) {
													options.classname.forEach(function(item) {
