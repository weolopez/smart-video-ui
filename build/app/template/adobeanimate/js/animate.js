...
function init2() {
  (function (lib, img, cjs) {
    ...
    lib.properties = {
      ...
      manifest: [
        {
          src: path + 'images/ATT_Logo.png',
          id: 'ATT_Logo'
        },
        {
          src: path + 'images/calendar.png',
          id: 'calendar'
        },
        {
          src: path + 'images/green2.png',
          id: 'green2'
        },
        {
          src: path + 'images/internet.png',
          id: 'internet'
        },
        {
          src: path + 'images/orangecircle1.png',
          id: 'orangecircle1'
        },
        {
          src: path + 'images/_package.png',
          id: '_package'
        },
        {
          src: path + 'images/people_11.png',
          id: 'people_11'
        },
        {
          src: path + 'images/people_12.png',
          id: 'people_12'
        },
        {
          src: path + 'images/people_13.png',
          id: 'people_13'
        },
        {
          src: path + 'images/people_14.png',
          id: 'people_14'
        },
        {
          src: path + 'images/purple_circle.png',
          id: 'purple_circle'
        },
        {
          src: path + 'images/tick.png',
          id: 'tick'
        },
        {
          src: path + 'images/tv.png',
          id: 'tv'
        },
        {
          src: path + 'sounds/vo2.mp3',
          id: 'vo2'
        },
        {
          src: path + 'sounds/vo8.mp3',
          id: 'vo8'
        }
      ]
    };
    ...
    (lib.Tween32 = function () {
      this.initialize();
      this.shape = new cjs.Shape();
      this.shape.graphics.lf([
        '#A4BD2E',
        '#5FA43D'
      ], [
        0,
        1
      ], -82, 0, 82, 0).s().p('ApDJDQjwjwABlTQgBlSDwjwQDxjwFSAAQFTAADwDwQDwDwABFSQgBFTjwDwQjwDxlTgBQlSABjxjxg');
    ...
    (lib.Tween30 = function () {
      ...
      this.shape.graphics.lf([
        ...
        0,
        1
      ], 0, -22.2, 0, 22.2).s().rr(-91, -21.5, 182, 43, 8);
    ...
    (lib.Tween19 = function (mode, startPosition, loop) {
      ...
      this.shape_1.graphics.lf([
        '#A4BD2E',
        '#5FA43D'
      ], [
        0,
        1
      ], -112.1, 0, 112.2, 0).s().p('AsYMYQlIlIAAnQQAAnPFIlJQFJlIHPAAQHQAAFIFIQFJFJAAHPQAAHQlJFIQlIFJnQAAQnPAAlJlJg');
      this.shape_2 = new cjs.Shape();
      this.shape_2.graphics.lf([
        '#A4BD2E',
        '#5FA43D'
      ], [
        0,
        1
      ], -110.9, 0, 111, 0).s().p('AsQMQQlElFAAnLQAAnKFElFQFGlFHKAAQHLAAFFFFQFFFFAAHKQAAHLlFFFQlFFFnLAAQnKAAlGlFg');
      this.shape_3 = new cjs.Shape();
      this.shape_3.graphics.lf([
        '#A4BD2E',
        '#5FA43D'
      ], [
        0,
        1
      ], -109.7, 0, 109.8, 0).s().p('AsHMHQlBlBAAnGQAAnFFBlCQFClBHFAAQHGAAFBFBQFCFCAAHFQAAHGlCFBQlBFCnGAAQnFAAlClCg');
      this.shape_4 = new cjs.Shape();
      this.shape_4.graphics.lf([
        '#A4BD2E',
        '#5FA43D'
      ], [
        0,
        1
      ], -108.5, 0, 108.6, 0).s().p('Ar/L/Qk9k+AAnBQAAnAE9k+QE/k+HAAAQHBAAE+E+QE+E+AAHAQAAHBk+E+Qk+E+nBAAQnAAAk/k+g');
      this.shape_4.setTransform(0.1, 0);
      this.shape_5 = new cjs.Shape();
      this.shape_5.graphics.lf([
        '#A4BD2E',
        '#5FA43D'
      ], [
        0,
        1
      ], -107.3, 0, 107.4, 0).s().p('Ar2L2Qk6k6AAm8QAAm7E6k7QE7k6G7AAQG8AAE6E6QE7E7AAG7QAAG8k7E6Qk6E7m8AAQm7AAk7k7g');
      this.shape_5.setTransform(0.1, 0);
      this.shape_6 = new cjs.Shape();
      this.shape_6.graphics.lf([
        '#A4BD2E',
        '#5FA43D'
      ], [
        0,
        1
      ], -106.1, 0, 106.2, 0).s().p('AruLuQk2k3AAm3QAAm2E2k3QE4k3G2AAQG3AAE3E3QE3E3AAG2QAAG3k3E3Qk3E3m3AAQm2AAk4k3g');
      ...
      }).to({ state: [{ t: this.shape_1 }] }, 1).to({ state: [{ t: this.shape_2 }] }, 1).to({ state: [{ t: this.shape_3 }] }, 1).to({ state: [{ t: this.shape_4 }] }, 1).to({ state: [{ t: this.shape_5 }] }, 1).to({ state: [{ t: this.shape_6 }] }, 1).to({
        state: [{
            t: this.shape,
            p: {
              scaleX: 1.28,
      ...
      }, 1).to({ state: [{ t: this.shape_6 }] }, 1).to({ state: [{ t: this.shape_5 }] }, 1).to({ state: [{ t: this.shape_4 }] }, 1).to({ state: [{ t: this.shape_3 }] }, 1).to({ state: [{ t: this.shape_2 }] }, 1).to({ state: [{ t: this.shape_1 }] }, 1).to({
        state: [{
            t: this.shape,
            p: {
              scaleX: 1.383,
    ...
    (lib.Tween10 = function () {
      ...
      this.shape_3.graphics.lf([
        ...
        0,
        1
      ], -34.1, 0, 34.2, 0).s().p('AjwDxQhkhkAAiNQAAiMBkhkQBkhkCMAAQCNAABkBkQBkBkAACMQAACNhkBkQhkBkiNAAQiMAAhkhkg');
    ...
    (lib.Tween7 = function () {
      ...
      this.shape.graphics.lf([
        ...
        0,
        1
      ], -50.8, 0, 50.8, 0).s().p('AlmFmQiViUAAjSQAAjRCViVQCViUDRAAQDSAACVCUQCUCVAADRQAADSiUCUQiVCWjSAAQjRAAiViWg');
    ...
    (lib._6grap = function (mode, startPosition, loop) {
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(98).to({ _off: false }, 0).to({
        x: 211.9,
        alpha: 1
      }, 13).wait(8));
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(77).to({ _off: false }, 0).to({
        x: 211.9,
        alpha: 1
      }, 13).wait(29));
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(55).to({ _off: false }, 0).to({
        x: 211.9,
        alpha: 1
      }, 13).wait(51));
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(23).to({ _off: false }, 0).to({
        scaleX: 1.48,
        scaleY: 1.48,
        alpha: 1
      }, 11).to({
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(28).to({ _off: false }, 0).to({
        scaleX: 0.45,
        scaleY: 0.45
      }, 11).to({
        scaleX: 0.36,
        scaleY: 0.36
      }, 5).to({ _off: true }, 1).wait(74));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib._5grap = function (mode, startPosition, loop) {
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance).to({
        ...
        scaleY: 0.84,
        y: -142.8
      }, 5, cjs.Ease.get(0.51)).to({
        scaleY: 1,
        y: -141.7
      }, 5, cjs.Ease.get(0.32)).wait(79).to({ startPosition: 0 }, 0).to({
        regY: -14.4,
        scaleY: 0.04,
        y: -148.1,
        alpha: 0
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({ _off: false }, 0).to({
        ...
        scaleX: 1,
        scaleY: 1
      }, 5).wait(73).to({ startPosition: 0 }, 0).to({
        scaleX: 0.1,
        scaleY: 0.1,
        alpha: 0
      }, 10).wait(1));
      ...
      this.instance_2.alpha = 0;
      this.instance_2._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(64).to({ _off: false }, 0).to({
        x: 154.9,
        alpha: 1
      }, 10).wait(29).to({ startPosition: 0 }, 0).to({
        x: 184.9,
        alpha: 0
      }, 10).wait(1));
      ...
      this.instance_3.alpha = 0;
      this.instance_3._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(54).to({ _off: false }, 0).to({
        x: 152.2,
        alpha: 1
      }, 10).wait(39).to({ startPosition: 0 }, 0).to({
        x: 182.2,
        alpha: 0
      }, 10).wait(1));
      ...
      this.instance_4.alpha = 0;
      this.instance_4._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(44).to({ _off: false }, 0).to({
        x: 154.9,
        alpha: 1
      }, 10).wait(49).to({ startPosition: 0 }, 0).to({
        x: 184.9,
        alpha: 0
      }, 10).wait(1));
      ...
      this.instance_5.alpha = 0;
      this.instance_5._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(34).to({ _off: false }, 0).to({
        x: 148.8,
        alpha: 1
      }, 10).wait(59).to({ startPosition: 0 }, 0).to({
        x: 178.8,
        alpha: 0
      }, 10).wait(1));
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(24).to({ _off: false }, 0).to({
        scaleX: 1,
        scaleY: 1,
        alpha: 1
      }, 10).wait(69).to({
      ...
      this.instance_7._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(8).to({ _off: false }, 0).to({
        scaleX: 0.7,
        scaleY: 0.7,
        alpha: 1
      }, 14).wait(81).to({ startPosition: 0 }, 0).to({
        scaleX: 0.05,
        scaleY: 0.05,
        alpha: 0
      }, 10).wait(1));
    ...
    (lib._3grap = function (mode, startPosition, loop) {
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance).to({
        ...
        y: -137.3,
        alpha: 0
      }, 11).to({ _off: true }, 3).wait(2));
      this.instance_1 = new lib.Tween18('synched', 0);
      this.instance_1.setTransform(-126.1, 53.6, 0.2, 0.2);
      this.instance_1.alpha = 0;
      this.instance_1._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(8).to({ _off: false }, 0).to({
        scaleX: 0.5,
        scaleY: 0.5,
        alpha: 1
      }, 8, cjs.Ease.get(-0.5)).to({
        scaleX: 1,
        scaleY: 1
      }, 16, cjs.Ease.get(-0.5)).to({ startPosition: 0 }, 125).to({
        scaleX: 0.29,
        scaleY: 0.29,
        alpha: 0
      }, 11).wait(5));
      ...
      this.instance_2._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(118).to({ _off: false }, 0).to({
        regY: -8.1,
        scaleY: 1.18,
        y: 68
      }, 13).to({
        ...
        scaleY: 0.83,
        y: 68.1
      }, 4).to({ scaleY: 1 }, 4).to({ startPosition: 0 }, 18).to({
        scaleX: 0.39,
        scaleY: 0.39,
        alpha: 0
      }, 11).wait(5));
      ...
      this.instance_3._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(108).to({ _off: false }, 0).to({
        regY: -9,
        scaleY: 1.17
      }, 13).to({ scaleY: 0.83 }, 4).to({ scaleY: 1 }, 4).to({ startPosition: 0 }, 28).to({
        regX: 1.1,
        regY: -9.1,
        scaleX: 0.53,
        scaleY: 0.53,
      ...
      this.instance_4.alpha = 0;
      this.instance_4._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(66).to({ _off: false }, 0).to({
        regY: -27,
        scaleY: 1.22,
        alpha: 1
      }, 10).to({
        ...
        scaleY: 1,
        y: -49
      }, 4).to({ startPosition: 0 }, 73).to({
        regX: 1.1,
        regY: -26.9,
        scaleX: 0.24,
        scaleY: 0.24,
        alpha: 0
      }, 11).to({ _off: true }, 1).wait(4));
      this.instance_5 = new lib.Tween19();
      this.instance_5.setTransform(251.7, 23.9);
      this.instance_5.alpha = 0;
      this.instance_5._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(16).to({ _off: false }, 0).to({
        x: 131.7,
        alpha: 1
      }, 21).wait(120).to({
        scaleX: 0.42,
    ...
    (lib._2grap = function (mode, startPosition, loop) {
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance).wait(16).to({ _off: false }, 0).to({
        scaleX: 1,
        scaleY: 1,
        alpha: 1
      }, 12, cjs.Ease.get(1)).wait(47).to({ startPosition: 0 }, 0).to({
        scaleX: 0.3,
        scaleY: 0.3,
        alpha: 0
      }, 12).wait(11));
      ...
      this.instance_1.alpha = 0;
      this.instance_1._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(13).to({ _off: false }, 0).to({
        scaleX: 1,
        scaleY: 1,
        alpha: 1
      }, 12, cjs.Ease.get(1)).wait(50).to({ startPosition: 0 }, 0).to({
        scaleX: 0.3,
        scaleY: 0.3,
        alpha: 0
      }, 12).wait(11));
      ...
      this.instance_2.alpha = 0;
      this.instance_2._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(39).to({ _off: false }, 0).to({
        regX: 192.8,
        scaleX: 1.1,
        x: 83.8,
        alpha: 1
        ...
        scaleX: 0.9,
        x: 83.9
      }, 4).to({ scaleX: 1 }, 4).wait(15).to({ startPosition: 0 }, 0).to({
        regX: 192.8,
        scaleX: 0.22,
        scaleY: 0.22,
        alpha: 0
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_3).to({
        ...
        scaleY: 1,
        alpha: 1
      }, 9).wait(66).to({ startPosition: 0 }, 0).to({
        scaleX: 0.3,
        scaleY: 0.3,
        alpha: 0
      }, 12).wait(11));
    ...
    (lib._1mov = function (mode, startPosition, loop) {
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance).to({
        x: -85.1,
        alpha: 1
      }, 19, cjs.Ease.get(1)).wait(23).to({ startPosition: 0 }, 0).to({
        x: -310.1,
        alpha: 0
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({ _off: false }, 0).to({
        x: 113.1,
        alpha: 1
      }, 12, cjs.Ease.get(1)).to({ startPosition: 0 }, 10).wait(10).to({ startPosition: 0 }, 0).to({
        scaleX: 0.12,
        scaleY: 0.12,
        x: 164.4,
        y: 24.1,
      ...
      this.instance_2.alpha = 0;
      this.instance_2._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(22).to({ _off: false }, 0).to({
        x: 106.4,
        y: -92.6,
        alpha: 1
      }, 10).wait(10).to({ startPosition: 0 }, 0).to({
        scaleX: 0.15,
        scaleY: 0.15,
        alpha: 0
      }, 10, cjs.Ease.get(1)).wait(1));
      ...
      this.instance_3.alpha = 0;
      this.instance_3._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(10).to({ _off: false }, 0).to({
        scaleX: 1,
        scaleY: 1,
        alpha: 1
      }, 16, cjs.Ease.get(1)).wait(16).to({ startPosition: 0 }, 0).to({
        scaleX: 0.19,
        scaleY: 0.19,
        y: 1.2,
        alpha: 0
      ...
      this.instance_4.alpha = 0;
      this.instance_4._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(10).to({ _off: false }, 0).to({
        scaleX: 1,
        scaleY: 1,
        alpha: 1
      }, 16, cjs.Ease.get(1)).wait(16).to({ startPosition: 0 }, 0).to({
    ...
    (lib.video_canvas = function (mode, startPosition, loop) {
      ...
      this.instance._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance).wait(1493).to({ _off: false }, 0).wait(53).to({
        mode: 'single',
        startPosition: 53
      }, 0).wait(122).to({
        mode: 'synched',
      ...
      this.instance_1._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(820).to({ _off: false }, 0).wait(99).to({
        mode: 'single',
        startPosition: 99
      }, 0).wait(553).to({
        mode: 'synched',
        loop: false
      }, 0).to({ _off: true }, 21).wait(1050));
      this.instance_2 = new lib._3grap('synched', 0, false);
      this.instance_2.setTransform(265.3, 191);
      this.instance_2._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(594).to({ _off: false }, 0).wait(102).to({
        mode: 'single',
        startPosition: 102
      }, 0).wait(28).to({
        mode: 'synched',
      ...
      this.instance_3._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(104).to({ _off: false }, 0).wait(58).to({
        mode: 'single',
        startPosition: 63
      }, 0).wait(411).to({
        mode: 'synched',
        loop: false
      }, 0).to({ _off: true }, 21).wait(1949));
      this.instance_4 = new lib._1mov('synched', 0, false);
      this.instance_4.setTransform(225.1, 165.6);
      this.instance_4._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(38).to({ _off: false }, 0).wait(39).to({
        mode: 'single',
        startPosition: 39
      }, 0).wait(20).to({
        mode: 'synched',
        loop: false
      }, 0).to({ _off: true }, 24).wait(2422));
      ...
      this.timeline.addTween(cjs.Tween.get(this.instance_5).to({
        y: 54.3,
        alpha: 1
      }, 7).to({ y: 301.6 }, 16, cjs.Ease.get(-0.44)).to({
        scaleX: 1.05,
        scaleY: 0.7,
        y: 308.1
      }, 4).to({
        ...
        x: 477.5,
        y: 42
      }, 20).to({ _off: true }, 2466).wait(19));
      this.instance_6 = new lib.Tween2('synched', 0);
      this.instance_6.setTransform(683.2, 48);
      this.instance_6.alpha = 0;
      this.instance_6._off = true;
      this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(47).to({ _off: false }, 0).to({
        x: 553.2,
        alpha: 1
      }, 11).wait(2485));
    }).prototype = p = new cjs.MovieClip();
